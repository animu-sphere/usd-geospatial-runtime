...
Design documents define intended contracts and may describe behavior that has
not been implemented. Current behavior belongs in [architecture/](../architecture/).

| Document | Status | Purpose |
| --- | --- | --- |
| [spec.md](spec.md) | Proposed | Overall product boundaries and evolution rules. |
